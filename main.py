  ...
  python main.py --full --crawl-single fpt # Full pipeline with single crawler
    ...
    try:
        if args.status:
            ...
            print("  --30day-aggregate                     : Use 30-day sentiment aggregation (default)")
            print("")
            print("💡 EXAMPLES:")
            ...
            print("  python main.py --sentiment-only --optimized-update : Fast sentiment update (old method)")
            print("-"*60)
            print("\n🎯 RECOMMENDED COMMANDS:")
            print("  python main.py                                      : Full pipeline with 30-day aggregation (DEFAULT)")
            print("  python main.py --full --recalculate-all-stock       : Full pipeline + recalculate sentiment")
            print("  python main.py --sentiment-only                     : Sentiment with 30-day aggregation only")
            print("  python main.py --sentiment-only --recalculate-all-stock : Fix sentiment statistics")
            print("  python main.py --status                             : Show system status only")
            print("="*80)
