...
class DatabaseConfig:
    ...
    SUPABASE_URL = os.getenv("SUPABASE_URL", "https://ebpnoasjxttbrdmiwesg.supabase.co")
    SUPABASE_KEY = os.getenv("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVicG5vYXNqeHR0YnJkbWl3ZXNnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc3MTA1MDUsImV4cCI6MjA2MzI4NjUwNX0.qp931AbeKsTpUZUj3OqLYSRlzDCWEWV7T4RboGerkN8")
